...
If you spot a bug, [search if an issue already exists](https://github.com/avenbreaks/xarchon/issues?q=is%3Aissue+is%3Aopen+label%3Abug). If a related issue doesn't exist, you can open a new issue using the [bug report template](https://github.com/avenbreaks/xarchon/issues/new?assignees=&labels=bug&template=bug-report.yml&title=%5Bbug%5D%3A+). 

### Feature Requests

If you have a feature request, search if a similar [feature request already exists](https://github.com/avenbreaks/xarchon/issues?q=is%3Aopen+is%3Aissue+label%3A%22feature+request%22). If a related feature request doesn't exist, you can open a [feature request](https://github.com/avenbreaks/xarchon/issues/new?assignees=&labels=feature+request&template=feature-request.yml&title=%5BFR%5D%3A+). 

### Documentation

If you notice an issue in our docs (e.g. typo, grammar, conflicting information), first search to see if there is [already an issue open for it](https://github.com/avenbreaks/xarchon/issues?q=is%3Aopen+is%3Aissue+label%3Adocs). Otherwise, please file a [docs issue report](https://github.com/avenbreaks/xarchon/issues/new?assignees=leeederek&labels=docs&template=docs-issue.yml&title=%5BDocs%5D%3A+) and we will address it as soon as we can.
