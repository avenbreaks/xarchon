...
REL_FILEPATH_UPDATE_PATTERNS["golang/xarchon_version/xarchon_version.go"]="(KurtosisVersion = \")[0-9]+.[0-9]+.[0-9]+(\")"
REL_FILEPATH_UPDATE_PATTERNS["typescript/src/xarchon_version/xarchon_version.ts"]="(xarchon_version: string = \")[0-9]+.[0-9]+.[0-9]+(\")"
