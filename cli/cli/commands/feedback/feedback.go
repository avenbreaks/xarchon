...
import (
	...
	"github.com/avenbreaks/xarchon/cli/cli/helpers/multi_os_command_executor"
...
const (
	...
	commandDescription      = "Give feedback, file a bug report or feature request, or get help from the Kurtosis team. " +
		...
		"* For bugs/issues, let us know in our GitHub " + user_support_constants.GitHubChooseNewIssuesUrl + "?version=" + xarchon_version.KurtosisVersion + ".\n" +
