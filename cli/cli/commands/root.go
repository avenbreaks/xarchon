...
import (
	...
	"github.com/avenbreaks/xarchon/cli/cli/commands/analytics"
	"github.com/avenbreaks/xarchon/cli/cli/commands/clean"
	"github.com/avenbreaks/xarchon/cli/cli/commands/cluster"
	"github.com/avenbreaks/xarchon/cli/cli/commands/config"
	"github.com/avenbreaks/xarchon/cli/cli/commands/discord"
	"github.com/avenbreaks/xarchon/cli/cli/commands/docs"
	kurtosisdump "github.com/avenbreaks/xarchon/cli/cli/commands/dump"
	"github.com/avenbreaks/xarchon/cli/cli/commands/enclave"
	"github.com/avenbreaks/xarchon/cli/cli/commands/engine"
	"github.com/avenbreaks/xarchon/cli/cli/commands/feedback"
	"github.com/avenbreaks/xarchon/cli/cli/commands/files"
	"github.com/avenbreaks/xarchon/cli/cli/commands/gateway"
	"github.com/avenbreaks/xarchon/cli/cli/commands/kurtosis_context"
	"github.com/avenbreaks/xarchon/cli/cli/commands/lsp"
	"github.com/avenbreaks/xarchon/cli/cli/commands/portal"
	"github.com/avenbreaks/xarchon/cli/cli/commands/run"
	"github.com/avenbreaks/xarchon/cli/cli/commands/service"
	"github.com/avenbreaks/xarchon/cli/cli/commands/twitter"
	"github.com/avenbreaks/xarchon/cli/cli/commands/version"
	"github.com/avenbreaks/xarchon/cli/cli/helpers/host_machine_directories"
	"github.com/avenbreaks/xarchon/cli/cli/helpers/logrus_log_levels"
	"github.com/avenbreaks/xarchon/cli/cli/helpers/user_send_metrics_election"
	"github.com/avenbreaks/xarchon/cli/cli/out"
	"github.com/avenbreaks/xarchon/cli/cli/user_support_constants"
...
func checkCLIVersion(cmd *cobra.Command) {
	...
	if err != nil {
		...
		logrus.Warningf("Your current version is '%v'", xarchon_version.KurtosisVersion)
...
func isLatestCLIVersion() (bool, string, error) {
	ownVersionStr := xarchon_version.KurtosisVersion
