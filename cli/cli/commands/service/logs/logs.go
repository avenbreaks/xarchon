...
import (
	...
	"github.com/avenbreaks/xarchon/cli/cli/helpers/kurtosis_config_getter"
	"github.com/avenbreaks/xarchon/cli/cli/kurtosis_config/resolved_config"
...
var ServiceLogsCmd = &engine_consuming_kurtosis_command.EngineConsumingKurtosisCommand{
	...
	Args: []*args.ArgConfig{
		...
		//TODO we should enable them when #879 is ready: https://github.com/avenbreaks/xarchon/issues/879
		...
		// TODO we should fix this after https://github.com/avenbreaks/xarchon/issues/879
...
func run(
	...
	//TODO related ticket: https://github.com/avenbreaks/xarchon/issues/1069
...
// https://github.com/avenbreaks/xarchon/issues/343
