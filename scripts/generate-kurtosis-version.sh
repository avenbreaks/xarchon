...
xarchon_version_PACKAGE_DIR="xarchon_version"
xarchon_version_GO_FILE="xarchon_version.go"
xarchon_version_PACKAGE_NAME="github.com/avenbreaks/xarchon/xarchon_version"
xarchon_version_PACKAGE_GOSUM_PATH="go.sum"
...
xarchon_version_go_file_abs_path="${root_dirpath}/${xarchon_version_PACKAGE_DIR}/${xarchon_version_GO_FILE}"
cat << EOF > "${xarchon_version_go_file_abs_path}"
package ${xarchon_version_PACKAGE_DIR}
